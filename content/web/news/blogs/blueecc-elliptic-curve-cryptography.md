...
This will take your message and use the private key to create an [ECSignature](https://kitura-next.github.io/BlueECC/Structs/ECSignature.html). This struct can then be verified with the corresponding public key:
...
If you would like to learn more about using the BlueECC API, [visit our API reference](https://kitura-next.github.io/BlueECC/index.html).

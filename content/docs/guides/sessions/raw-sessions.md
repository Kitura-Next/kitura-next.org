...
This guide demonstrates how to use the [Kitura-Session](https://github.com/Kitura-Next/Kitura-Session) package to manage user sessions in Kitura with Raw routing. If you are using Codable routing, follow the guide for [Kitura Session with type-safe sessions](./codable-session).
...
> For live applications, you should use a persistent store, such as a database, or [Kitura-Session-Redis](https://github.com/Kitura-Next/Kitura-Session-Redis).
